                      ...
                      int priv, int suggested_cat_num, int *new_cat_num)
{
   ...
   *new_cat_num = suggested_cat_num;
   ...
   g_signal_connect(GTK_OBJECT(import_record_ask_window), "destroy",
...
void import_gui(GtkWidget *main_window, GtkWidget *main_pane,
    ...
    for (i = 0; i < MAX_IMPORT_TYPES; i++) {
        ...
        g_signal_connect(GTK_OBJECT(radio_types[i]), "clicked",
    ...
    g_signal_connect(GTK_OBJECT(fileChooserWidget), "destroy",
