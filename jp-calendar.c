/* $Id: jp-calendar.c,v 1.1 2009/09/10 06:01:54 rikster5 Exp $ */

/*******************************************************************************
 * jp-calendar.c:  Translate Palm calendar data formats
 ...
 ***********************************************************************/
void
jp_free_Appointment(Appointment_t *a)
{
   if (a->exception != NULL) {
      free(a->exception);
      a->exception = NULL;
 ...
 ***********************************************************************/
int
jp_unpack_Appointment(Appointment_t *a, const pi_buffer_t *buf, datebookType type)
{
   int iflags, j, destlen;
   unsigned char *p2;
   unsigned long d;
 ...
 ***********************************************************************/
int
jp_pack_Appointment(const Appointment_t *a, pi_buffer_t *buf, datebookType type)
{
   int  iflags,
        destlen = 8;
   char *pos;
 ...
 ***********************************************************************/
int
jp_unpack_AppointmentAppInfo(AppointmentAppInfo_t *ai,
 ...
 ***********************************************************************/
int
jp_pack_AppointmentAppInfo(const AppointmentAppInfo_t *ai,
