...
#  endif
    ...
    g_signal_connect(GTK_OBJECT(output_pane), "button_release_event",
    ...
    g_signal_connect(GTK_OBJECT(button_datebook), "clicked",
    ...
    g_signal_connect(GTK_OBJECT(button_address), "clicked",
    ...
    g_signal_connect(GTK_OBJECT(button_todo), "clicked",
    ...
    g_signal_connect(GTK_OBJECT(button_memo), "clicked",
    ...
    g_signal_connect(GTK_OBJECT(button_locked), "clicked",
                       G_CALLBACK(cb_private),
                       GINT_TO_POINTER(SHOW_PRIVATES));
    g_signal_connect(GTK_OBJECT(button_masklocked), "clicked",
                       G_CALLBACK(cb_private),
                       GINT_TO_POINTER(HIDE_PRIVATES));
    g_signal_connect(GTK_OBJECT(button_unlocked), "clicked",
                       G_CALLBACK(cb_private),
    ...
    g_signal_connect(GTK_OBJECT(button_sync), "clicked",
                       G_CALLBACK(cb_sync),
    ...
    g_signal_connect(GTK_OBJECT(button_cancel_sync), "clicked",
    ...
    g_signal_connect(GTK_OBJECT(button_backup), "clicked",
                       G_CALLBACK(cb_sync),
                       GINT_TO_POINTER
